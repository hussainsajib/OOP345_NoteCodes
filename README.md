# OOP345_NoteCodes
These are the C++ codes from the course note book that taught for OOP345 (OO Software Developement Using C++) at Seneca College, where I am currently doing my Advanced Diploma in Computer Programming and Analysis (CPA). The lectures notes can be found <a href="https://scs.senecac.on.ca/~oop345/" target="_blank">here</a>. The book is written by one of our professor, <a href="https://scs.senecac.on.ca/~chris.szalwinski/"><strong>Chris Szalwinski</strong></a>The list of the chapters include:<br><br>
